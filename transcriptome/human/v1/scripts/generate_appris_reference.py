...
def main():
    ...
    transcripts_with_stop_codon = \
        pick_transcripts_with_stop_codon(protein_coding_transcripts, transcript_fasta_file)
    ...
    selected_count, discarded_count = \
       create_fasta_files( transcript_fasta_file, transcripts_with_stop_codon,
                           appris_selected_fasta, appris_discarded_fasta )
    ...
    create_bed_files(transcripts_with_stop_codon, appris_selected_fasta, output_base)
    ...
    ## CDS Length
    remainder_array, transcripts_with_CDS_violation = CDS_length(transcripts_with_stop_codon)
    ...
    ## Start - Stop Codon
    start_triplets, stop_triplets = \
        start_stop_codon(appris_selected_fasta, transcripts_with_stop_codon)

    print("\n\nStart Triplets:")
    for e, v in start_triplets:
        print("{}: {}".format(e, v))

    print("\n\nStop Triplets:")
    for e, v in stop_triplets:
        print("{}: {}".format(e, v))

    
    cds_lengths, t_lengths = find_cds_lengths(transcripts_with_stop_codon)
