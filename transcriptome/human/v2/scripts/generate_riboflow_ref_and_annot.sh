...
INPUT_FASTA=../raw/sequence/gencode.v34.pc_transcripts.fa.gz
INPUT_GTF=../raw/annotation/gencode.v34.annotation.gtf.gz
INPUT_APPRIS_LIST=../raw/annotation/appris_data.principal.txt.gz

mkdir -p ../riboflow_annot_and_ref
OUTPUT_BASE=../riboflow_annot_and_ref/appris_human_v2
